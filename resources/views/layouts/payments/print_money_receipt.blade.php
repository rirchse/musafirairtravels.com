    ...
    <tr>
      <td style="padding:15px">
          ...
          <table class="table">
            ...
            <tr>
              <td colspan="2"> <span>Received with thanks from: </span><span style="border-bottom:1px dotted; display:inline-block; width:550px"> {{$invoice->user_name}}</span> </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2">Payment For: <span style="border-bottom:1px dotted; display:inline-block; width:278px">Overall</span> Balance: <span style="border-bottom:1px dotted; display:inline-block; width:300px" id="balance">{{$invoice->balance}}</span></td>
            </tr>
            <tr>
              <td colspan="2">Paid Via: <span style="border-bottom:1px dotted; display:inline-block; width:250px">{{$invoice->payment_by}}</span> Account Name: <span style="border-bottom:1px dotted; display:inline-block; width:313px">MUSAFIR AIR TRAVELS</span></td>
            </tr>
            <tr>
              <td colspan="2"> For the purpose of: <span style="border-bottom:1px dotted; display:inline-block; width:604px">{{$invoice->details}}</span> </td>
            </tr>
            <tr>
              <td><br>
                <span style="border:1px dotted; font-size:18px;padding:5px 15px">Amount of Taka: <span id="number">{{$invoice->amount}}</span> BDT</span>
              </td>
            </tr>
          </table>
        </td>
