  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-7"> <!-- general form elements -->
      <div class="box box-primary">
        ...
        {!! Form::model($account, ['route' => ['account.update', $account->id], 'method' => 'PUT', 'files' => true]) !!}
        <div class="box-body">
          <div class="col-md-4">
            <div class="form-group">
              <label for="name">Account Name</label>
              <input type="text" name="name" id="name" class="form-control" placeholder="TBL, DBBL, Cash, bKash" value="{{$account->name}}">
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="form-control" name="type">
                ...
                <option value="Mobile Bank" {{$account->type == 'Mobile Bank'? 'selected':''}}>Mobile Bank</option>
              </select>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="number" name="balance" id="balance" class="form-control" step="0.01" placeholder="0.00" value="{{$account->balance}}">
            </div>
          </div>
          <div class="col-md-8">
            <div class="form-group">
              <label for="bank_name">Bank Name</label>
              <input type="text" name="bank_name" id="bank_name" class="form-control" value="{{$account->bank_name}}">
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" id="branch" name="branch" class="form-control" value="{{$account->branch}}">
            </div>
          </div>
          <div class="col-md-8">
            <div class="form-group">
              <label for="card_no">Card No.:</label>
              <input type="text" id="card_no" name="card_no" class="form-control" value="{{$account->card_no}}">
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label for="routing_no">Routing No.:</label>
              <input type="text" id="routing_no" name="routing_no" class="form-control" value="{{$account->routing_no}}">
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              {{ Form::label('details', 'Details:', ['class' => 'control-label']) }}
              {!! Form::textarea('details', $account->name,['class'=>'form-control', 'rows' => 5]) !!}
            </div>
          </div>
          <div class="col-md-12">
