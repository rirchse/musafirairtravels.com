  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-7"> <!-- general form elements -->
      <div class="box box-primary">
        {!! Form::model($invoice, ['route' => ['sale.session.update', $key], 'method' => 'PUT', 'files' => true]) !!}
          ...
          <div class="box-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" id="airline" type="text" name="airline" placeholder="Airline" value="{{$airline}}">
                </div>
            </div>
      ...
      <div class="col-md-5">
        <div class="box box-info box-body">
            ...
            <table class="table table-stripped">
                ...
                $count = 0;
                @endphp
                @foreach(Session::get('_sales') as $key => $sale)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('sale.session.edit', [$key, 'edit'])}}" class="text-warning" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;
                        <a href="{{route('sale.session.delete', [$key, $sale['type']])}}" class="text-danger" title="Delete"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                @php
