...
if(isset($vendor))
{
  $id = isset($vendor->id) ? $vendor->id:'';
  $name = isset($vendor->name) ? $vendor->name:'';
  $email = isset($vendor->email) ? $vendor->email:'';
  $contact = isset($vendor->contact) ? $vendor->contact:'';
  ...
  .info td {padding:5px}
    ...
    <section class="content">
      <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select name="vendor" id="vendor" class="form-control select2">
                    ...
                    <option value="{{$val->id}}" {{$client == $val->id || $id == $val->id ? 'selected':''}}>{{$val->name}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
        ...
        <div class="col-md-12">
          @if(!empty($sales))
          <div class="box box-primary" id="table"><table style="width:100%">
            <tr>
              <td style="width: 70%">
                <div id="heading" style="width:100%; border:0; margin-bottom:0;display:none">
