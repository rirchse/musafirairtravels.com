  ...
  <header class="main-header">
    ...
    <a href="/home" class="logo">
      ...
      <span class="logo-mini">
        <img src="{{asset('/img/icon-logo.png')}}" width="50" alt="">
      </span>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('sale.view.type', 'Air-Ticket') }}"><i class="fa fa-plane"></i> Invoice Air-Ticket</a></li>
            <li><a href="{{ route('sale.view.type', 'Non-Commission') }}"><i class="fa fa-circle-o"></i> Non-Commission Air Ticket</a></li>
            <li><a href="{{ route('invoice.type.index', 'VISA') }}"><i class="fa fa-circle-o"></i> Invoice VISA</a></li>
            <li><a href="{{ route('invoice.type.index', 'Hotel') }}"><i class="fa fa-circle-o"></i> Invoice Hotel</a></li>
            <li><a href="{{ route('invoice.type.index', 'Other') }}"><i class="fa fa-circle-o"></i>Invoice Other</a></li>
            <li><a href="{{route('sale.view.type', 'Reissue')}}"><i class="fa fa-calendar"></i>Re Issued Invoices</a></li>
            <li><a href="{{route('sale.refund.index')}}"><i class="fa fa-undo"></i> Refunded Air-Tickets</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('payment.type.index', 'Client')}}"><i class="fa fa-circle-o"></i> Client Payments</a></li>
            <li><a href="{{route('payment.type.index', 'Vendor')}}"><i class="fa fa-circle-o"></i> Vendor Payments</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('vendor.create')}}"><i class="fa fa-circle-o"></i> Add Vendor</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('employee.create') }}"><i class="fa fa-user-plus"></i> Add Employee</a></li>
            <li><a href="{{ route('employee.index') }}"><i class="fa fa-users"></i> View Employees</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('airlines')}}"><i class="fa fa-plane"></i> Airlines</a></li>
          </ul>
        </li>
