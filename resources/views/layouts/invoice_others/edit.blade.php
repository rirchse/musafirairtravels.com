  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-8"> <!-- general form elements -->
      <div class="box box-primary">
        {!! Form::model($invoice, ['route' => ['invoice.type.update', $invoice->id], 'method' => 'PUT', 'files' => true]) !!}
        ...
        <div class="box-body">
            ...
            <div id="clientInfo">
                ...
                <table class="table">
                    ...
                    <tr><td>{{$client->name}}</td><td>{{$client->contact}}</td><td>{{$client->email}}</td><td>{{$client->ticket_no}}</td></tr>
                </table>
                @endif
            </div>
          ...
          <div class="box-body">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control" id="product" name="product" required>
                        ...
                        <option value="VISA" {{$invoice->type == 'VISA'? 'selected':''}}>VISA</option>
                        <option value="Hotel" {{$invoice->type == 'Hotel'? 'selected':''}}>Hotel</option>
                        <option value="Other" {{$invoice->type == 'Other'? 'selected':''}}>Other</option>
                    </select>
                </div>
            </div>
            @if($type != 'VISA')
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="token" class="form-control" value="{{$invoice->token}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="delivery">Delivery Date</label>
                    <input type="date" name="delivery" class="form-control" value="{{$invoice->delivery}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="visa_no">VISA No.</label>
                    <input class="form-control" id="visa_no" type="text" name="visa_no" value="{{$invoice->visa_no}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="mofa_no">Mofa No.</label>
                    <input class="form-control" id="mofa_no" type="text" name="mofa_no" value="{{$invoice->mofa_no}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="okala_no">Okala No.</label>
                    <input class="form-control" id="okala_no" type="text" name="okala_no" value="{{$invoice->okala_no}}">
                </div>
            </div>
            @endif
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" id="quantity" type="number" name="quantity" set="0.01" required value="{{$invoice->quantity}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="unit_price">Unit Price <span class="req">*</span></label>
                    <input class="form-control" id="unit_price" type="number" name="unit_price" step="0.01" required value="{{$invoice->unit_price}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="total_sale">Total Sale</label>
                    <input class="form-control" id="total_sale" type="number" name="total_sale" step="0.01" value="{{$invoice->total_sale}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="cost_price">Purchase Price</label>
                    <input class="form-control" id="cost_price" type="number" name="cost_price" step="0.01" value="{{$invoice->cost_price}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="profit">Profit</label>
                    <input class="form-control" id="profit" type="number" name="profit" step="0.01" value="{{$invoice->profit}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="details" name="details" rows="5">{{$invoice->details}}</textarea>
                </div>
            </div>
            <div class="clearfix"></div>
...
<script>
    ...
    {
        var db_country = '{{$invoice->country}}';
    ...
    {
        var db_visa_type = '{{$invoice->visa_type}}';
