  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-8"> <!-- general form elements -->
      <div class="box box-primary">
        <?php echo Form::model($invoice, ['route' => ['invoice.type.update', $invoice->id], 'method' => 'PUT', 'files' => true]); ?>
        ...
        <div class="box-body">
            ...
            <div id="clientInfo">
                <?php if(isset($client)): ?>
                <table class="table">
                    <tr><th>Client Name</th><th>Contact</th><th>Email</th><th>Ticket No.</th></tr>
                    <tr><td><?php echo e($client->name); ?></td><td><?php echo e($client->contact); ?></td><td><?php echo e($client->email); ?></td><td><?php echo e($client->ticket_no); ?></td></tr>
                </table>
                <?php endif; ?>
            </div>
          ...
          <div class="box-body">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control" id="product" name="product" required>
                        ...
                        <option value="VISA" <?php echo e($invoice->type == 'VISA'? 'selected':''); ?>>VISA</option>
                        <option value="Hotel" <?php echo e($invoice->type == 'Hotel'? 'selected':''); ?>>Hotel</option>
                        <option value="Other" <?php echo e($invoice->type == 'Other'? 'selected':''); ?>>Other</option>
                    </select>
                </div>
            </div>
            <?php if($type != 'VISA'): ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="token" class="form-control" value="<?php echo e($invoice->token); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="delivery">Delivery Date</label>
                    <input type="date" name="delivery" class="form-control" value="<?php echo e($invoice->delivery); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="visa_no">VISA No.</label>
                    <input class="form-control" id="visa_no" type="text" name="visa_no" value="<?php echo e($invoice->visa_no); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="mofa_no">Mofa No.</label>
                    <input class="form-control" id="mofa_no" type="text" name="mofa_no" value="<?php echo e($invoice->mofa_no); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="okala_no">Okala No.</label>
                    <input class="form-control" id="okala_no" type="text" name="okala_no" value="<?php echo e($invoice->okala_no); ?>">
                </div>
            </div>
            <?php endif; ?>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" id="quantity" type="number" name="quantity" set="0.01" required value="<?php echo e($invoice->quantity); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="unit_price">Unit Price <span class="req">*</span></label>
                    <input class="form-control" id="unit_price" type="number" name="unit_price" step="0.01" required value="<?php echo e($invoice->unit_price); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="total_sale">Total Sale</label>
                    <input class="form-control" id="total_sale" type="number" name="total_sale" step="0.01" value="<?php echo e($invoice->total_sale); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" id="profit" type="number" name="profit" step="0.01" value="<?php echo e($invoice->profit); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="details" name="details" rows="5"><?php echo e($invoice->details); ?></textarea>
                </div>
            </div>
            <div class="clearfix"></div>
...
<script>
    ...
    {
        var db_country = '<?php echo e($invoice->country); ?>';
        var country = document.getElementById('country');
        for(var x = 0; x<country.options.length; x++)
        {
            if(db_country == country.options[x].value)
            {
                country.options[x].setAttribute('selected', '');
                break;
            }
        }
    }
    ...
    /* select visa type */
    function selectVisaType()
    {
        var db_visa_type = '<?php echo e($invoice->visa_type); ?>';
        var visa_type = document.getElementById('visa_type');
        for(var x = 0; x<visa_type.options.length; x++)
        {
            if(db_visa_type == visa_type.options[x].value)
            {
                visa_type.options[x].setAttribute('selected', '');
                break;
            }
        }
    }
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/musafir/resources/views/layouts/invoice_others/edit.blade.php ENDPATH**/ ?>