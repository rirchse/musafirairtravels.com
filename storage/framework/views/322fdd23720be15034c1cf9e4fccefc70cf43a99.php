...
<section class="content">
          ...
          <div class="box-body">
            <table class="table table-bordered">
              <tr>
                ...
                <th>Refund Chareg Taken by Vendor</th>
              </tr>
              <?php $__currentLoopData = Session::get('_refunds'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td><input type="number" class="form-control" name="client_charge" id="client_charge" step="0.01" onkeyup="calc()" required></td>
                <td><?php echo e($val->name); ?></td>
                <td><?php echo e($val->airline); ?></td>
                <td><?php echo e($val->purchase); ?></td>
                <td><input type="number" class="form-control" name="vendor_charge" id="vendor_charge" step="0.01" onkeyup="calc()"></td>
              </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </table>
            <div class="col-md-12">
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/musafir/resources/views/layouts/sales/refund_create.blade.php ENDPATH**/ ?>