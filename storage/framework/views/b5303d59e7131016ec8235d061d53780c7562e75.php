  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-8"> <!-- general form elements -->
      <div class="box box-primary">
        <?php echo Form::open(['route' => 'invoice.type.store', 'method' => 'POST', 'files' => true]); ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control" id="product" name="product" required>
                        ...
                        <option value="VISA" <?php echo e($type == 'VISA'?'selected':''); ?>>VISA</option>
                        <option value="Hotel" <?php echo e($type == 'Hotel'?'selected':''); ?>>Hotel</option>
