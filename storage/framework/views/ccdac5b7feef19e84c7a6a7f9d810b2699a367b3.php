  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-7"> <!-- general form elements -->
      <div class="box box-primary">
        <?php echo Form::open(['route' => 'sale.store.session', 'method' => 'POST', 'files' => true]); ?>
          ...
          <div class="box-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" id="airline" type="text" name="airline" placeholder="Airline" value="<?php echo e($airline); ?>" list="airlines" onkeyup="getAirlines(this)">
      ...
      <div class="col-md-5">
        <div class="box box-info box-body">
            ...
            <table class="table table-stripped">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo e(route('sale.session.edit', $count)); ?>" class="text-warning" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;
                        <a href="<?php echo e(route('sale.session.delete', [$key, $type])); ?>" class="text-danger" title="Delete"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                <?php
            ...
            <div class="box-footer"> 
                <a class="btn btn-warning pull-" href="<?php echo e(route('sale.session.close', $type)); ?>" onclick="return confirm('Are you sure you want to close these invoices?')">Close</a> &nbsp; 
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <form action="<?php echo e(route('sale.add.client')); ?>" method="POST">
            <?php echo csrf_field(); ?>
