        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                <form action="<?php echo e(route('vendor.search')); ?>" method="post" class="form-inline">
                  <?php echo csrf_field(); ?>
                  <a href="<?php echo e(route('vendor.create')); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i></a>
