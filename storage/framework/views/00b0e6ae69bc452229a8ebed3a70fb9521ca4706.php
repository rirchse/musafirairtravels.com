  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-7"> <!-- general form elements -->
      <div class="box box-primary">
        <?php echo Form::model($invoice, ['route' => ['sale.session.update', $key], 'method' => 'PUT', 'files' => true]); ?>
        ...
        <div class="box-body">
            ...
            <div id="clientInfo">
                <?php if(isset($client)): ?>
                <table class="table"><tr><th>Client Name</th><th>Contact</th><th>Email</th><th>Ticket No.</th></tr><tr><td><?php echo e($client->name); ?></td><td><?php echo e($client->contact); ?></td><td><?php echo e($client->email); ?></td><td><?php echo e($client->ticket_no); ?></td></tr></table>
                <?php endif; ?>
            </div>
          ...
          <div class="box-body">
            <input type="hidden" id="customer_id" name="customer_id" value="<?php echo e($customer_id); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('ticket_no',  $ticket_no, ['class' => 'form-control', 'placeholder' => 'Ticket Number', 'required' => '', 'step' => '0.01', 'onkeyup' => 'checkTicketNo(this)'])); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" id="air_ticket_class" name="air_ticket_class">
                        ...
                        <option value="Economy" <?php echo e($air_ticket_class == 'Economy'? 'selected':''); ?>>Economy Class</option>
                        <option value="Business" <?php echo e($air_ticket_class == 'Business'? 'selected':''); ?>>Business Class</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" id="airline" type="text" name="airline" placeholder="Airline" value="<?php echo e($airline); ?>">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <?php echo e(Form::number('gross_fare', $gross_fare, ['class' => 'form-control', 'placeholder' => 'Gross Fare(Sale)', 'step' => '0.01'])); ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <?php echo e(Form::number('base_fare', $base_fare, ['class' => 'form-control', 'placeholder' => 'Base Fare(Buy)', 'step' => '0.01'])); ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" id="commission" type="number" name="commission" placeholder="Commission %" value="<?php echo e($commission); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="commission_amount">Commission Amount</label>
                    <input class="form-control" id="commission_amount" type="number" name="commission_amount" placeholder="Commission amount" value="<?php echo e($commission_amount); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="net_commission">Net Commission</label>
                    <input class="form-control" id="net_commission" type="number" name="net_commission" placeholder="Net Commission" value="<?php echo e($net_commission); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="ait">AIT</label>
                    <input class="form-control" id="ait" type="number" name="ait" placeholder="AIT" value="<?php echo e($ait); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="discount">Discount Amount</label>
                    <input class="form-control" id="discount" type="number" name="discount" placeholder="Discount in Amount" value="<?php echo e($discount); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="other_bonus">Other Bonus</label>
                    <input class="form-control" id="other_bonus" type="number" name="other_bonus" placeholder="Other Bonus" value="<?php echo e($other_bonus); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="extra_fee">Extra Fee</label>
                    <input class="form-control" id="extra_fee" type="number" name="extra_fee" placeholder="Extra Fee" value="<?php echo e($extra_fee); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="other_expense">Other Expense</label>
                    <input class="form-control" id="other_expense" type="number" name="other_expense" placeholder="Other Expense" value="<?php echo e($other_expense); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="vat">VAT</label>
                    <input class="form-control" id="vat" type="number" name="vat" placeholder="VAT" value="<?php echo e($vat); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="tax">Tax</label>
                    <input class="form-control" id="tax" type="number" name="tax" placeholder="Tax" value="<?php echo e($tax); ?>" step="0.01">
                </div>
            </div>
            <?php endif; ?>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" id="route" type="text" name="route" placeholder="Route/Sector" value="<?php echo e($route); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="pnr">PNR</label>
                    <input class="form-control" id="pnr" type="text" name="pnr" placeholder="PNR" value="<?php echo e($pnr); ?>">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" id="gds" type="text" name="gds" placeholder="GDS" value="<?php echo e($gds); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="segment">Segment</label>
                    <input class="form-control" id="segment" type="text" name="segment" placeholder="Segment" value="<?php echo e($segment); ?>">
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" id="client_price" type="number" name="client_price" placeholder="Client Price" value="<?php echo e($client_price); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="purchase">Purchase</label>
                    <input class="form-control" id="purchase" type="number" name="purchase" placeholder="Purchase" value="<?php echo e($purchase); ?>" step="0.01">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="profit">Profit</label>
                    <input class="form-control" id="profit" type="number" name="profit" placeholder="Profit" value="<?php echo e($profit); ?>" step="0.01">
                </div>
            </div>
            <div class="clearfix"></div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" id="issue_date" type="date" name="issue_date" placeholder="Issue Date" value="<?php echo e($issue_date); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="journey_date">Journey Date</label>
                    <input class="form-control" id="journey_date" type="date" name="journey_date" placeholder="Journey Date" value="<?php echo e($journey_date); ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label" for="return_date">Return Date</label>
                    <input class="form-control" id="return_date" type="date" name="return_date" placeholder="Return Date" value="<?php echo e($return_date); ?>">
                </div>
            ...
            <div class="box-header with-border">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input class="form-control" id="pax_name" type="text" name="pax_name" placeholder="Type Passenger Name" value="<?php echo e($pax_name); ?>">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <select class="form-control" id="pax_type" name="pax_type">
                        ...
                        <option value="Adult" <?php echo e($pax_type == 'Adult'?'selected':''); ?>>Adult</option>
                        <option value="Child" <?php echo e($pax_type == 'Child'?'selected':''); ?>>Child</option>
                        <option value="Infant" <?php echo e($pax_type == 'Infant'?'selected':''); ?>>Infant</option>
                        <option value="Others" <?php echo e($pax_type == 'Others'?'selected':''); ?>>Others</option>
                      </select>
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input class="form-control" id="pax_mobile" type="phone" name="pax_mobile" placeholder="Mobile Number" value="<?php echo e($pax_mobile); ?>">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      <label class="control-label" for="pax_email">Email</label>
                      <input class="form-control" id="pax_email" type="email" name="pax_email" placeholder="Email Address" value="<?php echo e($pax_email); ?>">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      <label class="control-label" for="passport">Passport No.</label>
                      <input class="form-control" id="passport" type="text" name="passport_no" placeholder="Passport No." value="<?php echo e($passport_no); ?>">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      <label class="control-label" for="nid">NID No.</label>
                      <input class="form-control" id="nid" type="text" name="nid" placeholder="NID No." value="<?php echo e($nid); ?>">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      <label class="control-label" for="birth_date">Date of Birth</label>
                      <input class="form-control" id="birth_date" type="date" name="birth_date" placeholder="Date of Birth" value="<?php echo e($birth_date); ?>">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      <label class="control-label" for="pax_issue_date">Passport Issue Date</label>
                      <input class="form-control" id="pax_issue_date" type="date" name="pax_issue_date" placeholder="Passport Issue Date" value="<?php echo e($pax_issue_date); ?>">
                  </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label" for="pax_expire_date">Passport Expire Date</label>
                  <input class="form-control" id="pax_expire_date" type="date" name="pax_expire_date" placeholder="Passport Expire Date" value="<?php echo e($pax_expire_date); ?>">
                  </div>
              </div>
            <div class="clearfix"></div>
      ...
      <div class="col-md-5">
        <div class="box box-info box-body">
            ...
            <table class="table table-stripped">
                ...
                $count = 0;
                ?>
                <?php $__currentLoopData = Session::get('_sales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="ticket_no"><?php echo e($sale['ticket_no']); ?></td>
                    <td><?php echo e($sale['client_price']); ?></td>
                    <td><?php echo e($sale['purchase']); ?></td>
                    <td><?php echo e($sale['profit']); ?></td>
                    <td>
                        <a href="<?php echo e(route('sale.copy', $sale['ticket_no'])); ?>" class="text-primary" title="Copy"><i class="fa fa-copy"></i></a>&nbsp;
                        <a href="<?php echo e(route('sale.session.edit', [$key, 'edit'])); ?>" class="text-warning" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;
                        <a href="<?php echo e(route('sale.session.delete', [$key, $sale['type']])); ?>" class="text-danger" title="Delete"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                <?php
                ...
                <tr>
                    <th>Total = </th>
                    <th><?php echo e($total_client_price); ?></th>
                    <th><?php echo e($total_purchase); ?></th>
                    <th><?php echo e($total_profit); ?></th>
                    <th></th>
                </tr>
            </table>
            <div class="box-footer"> 
                <a class="btn btn-warning pull-" href="">Close</a> &nbsp; 
                <a class="btn btn-info pull-" href="<?php echo e(route('sale.store.multi')); ?>"><i class="fa fa-save"> </i> Confirm</a>
            </div>
        </div>
      </div>
      <?php endif; ?>
...
<script type="text/javascript">
    ...
    {
        client_price.value = (Number(purchase.value) + Number(extra_fee.value) + Number(profit.value)).toFixed(2);
    }
        ...
        $.ajax({
            ...
            success: function (data){
                ...
                $.each(obj['success'], function (key, val){
                    names += '<option value="'+val.airline+'">';
                });
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/musafir/resources/views/layouts/sales/edit-session.blade.php ENDPATH**/ ?>