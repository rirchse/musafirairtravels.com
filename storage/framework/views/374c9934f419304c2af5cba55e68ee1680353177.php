...
<section class="content">
  <div class="row"> <!-- left column -->
    <div class="col-md-7"> <!-- general form elements -->
      <div class="box box-primary">
        ...
        <?php echo Form::open(['route' => 'account.store', 'method' => 'POST', 'files' => true]); ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/musafir/resources/views/layouts/accounts/create.blade.php ENDPATH**/ ?>